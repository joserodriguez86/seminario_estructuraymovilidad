...
```{r}
base_esa <- base_esa %>% 
  mutate(clase_torrado = case_when(
...
Como vamos a utilizar la variable de clase social en las clases posteriores vamos a guardar la base de datos en un archivo `.RDS`.  

```{r}
saveRDS(base_esa, "fuentes/base_esa_pisac.rds")
```
